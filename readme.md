...
Run com.densoft.springboot.web.SpringBootFirstWebApplication as a Java Application.
...
- `security.com.densoft.springboot.web.SecurityConfiguration` contains the in memory security credential configuration.
